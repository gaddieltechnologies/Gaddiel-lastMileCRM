...
.trclick
{
	...
	<form action="clientCategory.php" method="POST" name="forms">
	<div id="main-content">
		<!-- Container -->
		<div class="container">
			<!-- Header boxes -->
			   ...
			   <div class="span12 desktop">
				 <div class="widget"> 
					...
					<div class="widget-content "> 
						<div class="span8"><h3>Client Category</h3></div>                       
						<div class="span3">                                                                
							<div class="box-holder">
                                 <a href="addClientCategory.php" onClick="newPage()">
				...
				<!-- /Content -->
					<div class="span12">
					    <div class="widget">					
						<div class="widget-content">
							<div class="mobile"><h3>Client Category</h3></div> 						              
							<div class="span8"><input type="text" autofocus class="span5" placeholder="Search by Client Category" id="searchphone" name="ClientCategory"/></div>                          
							<div class="span3"> 
							...
							<!--<table class="table table-striped table-bordered">-->                            
								...
								<tbody id="gridvaluediv" class="mytable1">	
								 <?php 
									...
									$result = $pdo->prepare("SELECT ID,CLIENT_CATEGORY,DESCRIPTION FROM CLIENT_CATEGORY ORDER BY ID DESC");
		                            $result->execute();
		                            Database::disconnect();
								...
								if ( !empty($_POST)) {	
									...
									$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									$sql="SELECT  ID,CLIENT_CATEGORY,DESCRIPTION FROM CLIENT_CATEGORY WHERE  CLIENT_CATEGORY LIKE :ClientCategory;";
									$result=$pdo->prepare($sql);
									
									$result->bindValue(':ClientCategory',$CLIENT_CATEGORY.'%');
									$result->execute();
									}
			 				      ...
			 				      ?>
                                    ...
                                    <td class="actions">
											<a href="editClientCategory.php?id=<?php echo $row['ID']; ?>" class="btn btn-small "><i class="icon-pencil"></i></a>
											<a href="deleteClientCategory.php?id=<?php echo $row['ID']; ?>" class="btn btn-small" onclick="return confirm('Are you sure?')" ><i class="icon-remove"></i></a>
										</td>
				...
				<div class="navbar navbar-fixed-bottom">
					<div class="navbar-inner">
						<div class="container">                         
							   ...
							   <a href="addClientCategory.php" class="newenable btn btn-default" onClick="newPage()" id="newenable">
