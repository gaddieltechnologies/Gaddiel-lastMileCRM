				...
				<!-- /Content -->
					<div class="span12">
						...
						<div class="widget-content">
							...
							<div class="span8"><input type="text" autofocus class="span5" placeholder="Search by Client Class" id="searchphone" name="ClientClass"/></div>                          
							...
							<!--<table class="table table-striped table-bordered">-->                            
								<thead>
									   <tr class="widget-header">
										...
										<th data-toggle="true">Client Class</th>
								...
								if ( !empty($_POST)) {	
									...
									$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									$sql="SELECT  ID,CLIENT_CLASS,DESCRIPTION FROM CLIENT_CLASS WHERE  CLIENT_CLASS LIKE :ClientClass;";
