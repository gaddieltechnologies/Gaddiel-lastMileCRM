			   ...
			   <div class="span12 desktop">
				 <div class="widget">                 					
					<div class="widget-content "> 
						<div class="span8"><h3>Department</h3></div>                       
						<div class="span3">                                                                
							<div class="box-holder">
                                 <a href="addDepartment.php" onClick="newPage()">
				...
				<!-- /Content -->
					<div class="span12">
					    <div class="widget">					
						<div class="widget-content">
							<div class="mobile"><h3>Department</h3></div> 						
	                                  
							<div class="span8"><input type="text" autofocus class="span5" placeholder="Search by Department" id="searchDepartment" name="searchDepartment"/></div>                          
							...
							<!--<table class="table table-striped table-bordered">-->                            
								...
								<tbody id="gridvaluediv" class="mytable1">	
								 ...
								 <?php 
									...
									$result = $pdo->prepare("SELECT ID,DEPARTMENT_NAME,DESCRIPTION FROM DEPARTMENT ORDER BY ID DESC");
		                            $result->execute();														
									Database::disconnect();
								   
									if ( !empty($_POST)) {	
								   
			                        $DEPARTMENT_NAME = $_POST['searchDepartment'];									
									$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									$sql="SELECT ID,DEPARTMENT_NAME,DESCRIPTION FROM DEPARTMENT WHERE  DEPARTMENT_NAME LIKE :searchDepartment;";
									$result=$pdo->prepare($sql);
									$result->bindValue(':searchDepartment',$DEPARTMENT_NAME.'%');
									$result->execute();
									}
			 				      ...
			 				      ?>		 
                                    ...
                                    <td class="actions">
											<a href="editDepartment.php?id=<?php echo $row['ID']; ?>" class="btn btn-small "><i class="icon-pencil"></i></a>
											<a href="deleteDepartment.php?id=<?php echo $row['ID']; ?>" class="btn btn-small" onclick="return confirm('Are you sure?')"><i class="icon-remove"></i></a>
										</td>
        ...
        <div class="navbar navbar-fixed-bottom">
            <div class="navbar-inner">
                <div class="container">                         
                       ...
                       <a href="addDepartment.php" class="newenable btn btn-default" onClick="newPage()" id="newenable">
