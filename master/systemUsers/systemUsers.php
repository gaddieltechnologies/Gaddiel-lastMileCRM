			   ...
			   <div class="span12 desktop">
				 <div class="widget">                 					
					<div class="widget-content "> 
						<div class="span8"><h3>System Users</h3></div>                       
						<div class="span3">                                                                
							<div class="box-holder">
                                 <a href="addSystemUsers.php" onClick="newPage()">
				...
				<!-- /Content -->
					<div class="span12">
					    <div class="widget">					
						<div class="widget-content">
							<div class="mobile"><h3>System Users</h3></div> 						
	                        <div class="span5"><input type="text" autofocus class="span5" placeholder="Search by Name"  id="searchUserName" name="searchUserName"/></div>               
							<div class="span4"><input type="text" class="span4" placeholder="Search by Email Id" id="searchEmailId" name="searchEmailId"/></div>                          
							...
							<!--<table class="table table-striped table-bordered">-->                            
								...
								<tbody id="gridvaluediv" class="mytable1">	
								 ...
								 <?php 
									...
									$result = $pdo->prepare("SELECT ID,USER_NAME,EMAIL_ID FROM SYSTEM_USERS ORDER BY ID DESC");
		                            $result->execute();														
									Database::disconnect();
								   
									if ( !empty($_POST)) {	
								    $USER_NAME = $_POST['searchUserName'];
			                        $EMAIL_ID = $_POST['searchEmailId'];									
									$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									$sql="SELECT ID,USER_NAME,EMAIL_ID FROM SYSTEM_USERS WHERE USER_NAME LIKE :searchUserName AND EMAIL_ID LIKE :searchEmailId;";
									$result=$pdo->prepare($sql);
									$result->bindValue(':searchUserName',$USER_NAME.'%');
									$result->bindValue(':searchEmailId',$EMAIL_ID.'%');
									$result->execute();
									}
			 				      ...
			 				      ?>		 
                                    ...
                                    <td class="actions">
											<a href="editSystemUsers.php?id=<?php echo $row['ID']; ?>" class="btn btn-small "><i class="icon-pencil"></i></a>
											<a href="deleteSystemUsers.php?id=<?php echo $row['ID']; ?>" class="btn btn-small" onclick="return confirm('Are you sure?')"><i class="icon-remove"></i></a>
										</td>
        ...
        <div class="navbar navbar-fixed-bottom">
            <div class="navbar-inner">
                <div class="container">                         
                       ...
                       <a href="addSystemUsers.php" class="newenable btn btn-default" onClick="newPage()" id="newenable">
