...
<!-- Navbar -->
	...
	<form action="addVisitPurposes.php" method="POST" onSubmit="return Validate();">
	<!-- Main content -->
	<div id="main-content">
		<!-- Container -->
		<div class="container">
									...
									<div class="container">                  
											<center>
												<div class="btn-group btn-group-justified">                      
													...
													<a href="VisitPurposes.php" class="btn btn-default">
...
<?php
        ...
        // 	     $valid = true;
               ...
               if($rows > 0) {
                ...
                Database::disconnect();	
               	header('Location:VisitPurposes.php');
				ob_end_flush();
                exit;
		    }
