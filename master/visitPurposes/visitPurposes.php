					...
					<div class="widget-content "> 
						...
						<div class="span3">                                                                
							<div class="box-holder">
                                 <a href="addVisitPurposes.php" onClick="newPage()">
				...
				<!-- /Content -->
					<div class="span12">
						...
						<div class="widget-content">
							...
							<div class="span8"><input type="text" autofocus class="span6" placeholder="Search by Purpose" id="searchPurposeName" name="searchPurposeName"/></div>                          
							...
							<!--<table class="table table-striped table-bordered">-->                            
								<thead>
									   <tr class="widget-header">
										...
										<th data-toggle="true">Purpose</th>
                                ...
                                <?php 
									...
									$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									$sql="SELECT ID,PURPOSE_NAME,DESCRIPTION FROM VISIT_PURPOSES WHERE PURPOSE_NAME LIKE :searchPurposeName ORDER BY ID ASC;";
			 				      ...
			 				      ?>	
                                    ...
                                    <td class="actions">
											...
											<a href="editVisitPurposes.php?id=<?php echo $row['ID']; ?>" class="btn btn-small "><i class="icon-pencil"></i></a>											
											<a href="deleteVisitPurposes.php?id=<?php echo $row['ID']; ?>" class="btn btn-small " onclick="return confirm('Are you sure?')"><i class="icon-remove"></i></a>
        ...
        <div class="navbar navbar-fixed-bottom">
            <div class="navbar-inner">
                <div class="container">                         
                       ...
                       <a href="addVisitPurposes.php" class="newenable btn btn-default" onClick="newPage()" id="newenable">
