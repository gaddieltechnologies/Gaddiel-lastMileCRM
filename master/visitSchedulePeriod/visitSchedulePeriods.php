			   ...
			   <div class="span12 desktop">
				 <div class="widget">                 					
					<div class="widget-content "> 
						<div class="span8"><h3>Visit Schedule Periods</h3></div>                       
						<div class="span3">                                                                
							<div class="box-holder">
                                 <a href="addVisitSchedulePeriods.php" onClick="newPage()">
				...
				<!-- /Content -->
					<div class="span12">
					    <div class="widget">					
						<div class="widget-content">
							<div class="mobile"><h3>Schedule periods</h3></div> 							                          
							<div class="span8"><input type="text" autofocus class="span5" placeholder="Search by Schedule Periods" id="searchSchedulePeriods" name="searchSchedulePeriods"/></div>                          
							...
							<!--<table class="table table-striped table-bordered">-->                            
								<thead>
									   <tr class="widget-header">
										...
										<th data-toggle="true">Schedule Periods</th>
								...
								<tbody id="gridvaluediv" class="mytable1">	
								 ...
								 <?php 
									...
									$result = $pdo->prepare("SELECT ID,SCH_PERIOD,DESCRIPTION FROM VISIT_SCH_PERIODS ORDER BY ID DESC");
		                            $result->execute();														
									Database::disconnect();
								   
									if ( !empty($_POST)) {	
						
			                        $SCH_PERIOD = $_POST['searchSchedulePeriods'];									
									$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									$sql="SELECT ID,SCH_PERIOD,DESCRIPTION FROM VISIT_SCH_PERIODS WHERE  SCH_PERIOD LIKE :searchSchedulePeriods;";
									$result=$pdo->prepare($sql);
									$result->bindValue(':searchSchedulePeriods',$SCH_PERIOD.'%');
									$result->execute();
									}
			 				      ...
			 				      ?>		 
                                    ...
                                    <td class="actions">
											<a href="editVisitSchedulePeriods.php?id=<?php echo $row['ID']; ?>" class="btn btn-small "><i class="icon-pencil"></i></a>
											<a href="deleteVisitSchedulePeriods.php?id=<?php echo $row['ID']; ?>" class="btn btn-small" onclick="return confirm('Are you sure?')"><i class="icon-remove"></i></a>
										</td>
										
										<td><?php  echo $row['SCH_PERIOD'];?></td>
        ...
        <div class="navbar navbar-fixed-bottom">
            <div class="navbar-inner">
                <div class="container">                         
                       ...
                       <a href="addVisitSchedulePeriods.php" class="newenable btn btn-default" onClick="newPage()" id="newenable">
...
function clearvalue()
{
 ...
 document.getElementById("searchSchedulePeriods").value="";
}
</script>
