			   ...
			   <div class="span12 desktop">
				 <div class="widget">                 					
					<div class="widget-content "> 
						<div class="span8"><h3>Client Prospects</h3></div>                       
						<div class="span3">                                                                
							<div class="box-holder">
                                 <a href="addClientProspects.php" onClick="newPage()">
				...
				<!-- /Content -->
					<div class="span12">
					    <div class="widget">					
						<div class="widget-content">
							<div class="mobile"><h3>Client Prospects</h3></div> 													              
							<div class="span3"><input type="text" class="span3" placeholder="Search by Client Name" autofocus id="ClientName" name="ClientName"/></div>
							 ...
							 <div class="span3"><input type="text" class="span3" placeholder="Search by Contact Number"  id="ContactNumber"  name="ContactNumber"/></div> 
				...
				<div class="navbar navbar-fixed-bottom">
					<div class="navbar-inner">
						<div class="container">                         
							   ...
							   <a href="addClientProspects.php" class="newenable btn btn-default" onClick="newPage()" id="newenable">
