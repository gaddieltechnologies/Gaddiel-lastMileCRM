			   ...
			   <div class="span12 desktop">
				 <div class="widget">                 					
					<div class="widget-content "> 
						<div class="span8"><h3>Visit Reports</h3></div>                       
						<div class="span3">                                                                
							<div class="box-holder">
                                 <a href="addEnterVisitReports.php" onClick="newPage()">
				...
				<!-- /Content -->
					<div class="span12">
					    <div class="widget">					
						<div class="widget-content">
							<div class="mobile"><h3>Visit Reports</h3></div> 													              
							<div class="span3"><input type="text" class="span3" placeholder="Search by Employee " autofocus id="EMP_NAME" name="EMP_NAME"/></div>
							 ...
							 <div class="span3"><input type="text" class="span3" placeholder="Search by Visit Date Time"  id="VISIT_DATE"  name="VISIT_DATE"/></div> 
							...
							<!--<table class="table table-striped table-bordered">-->                            
								...
								$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									 $result = $pdo->prepare("select visrep.ID ID, emp.EMP_NAME EMP_NAME, clt.CLIENT_NAME CLIENT_NAME, visrep.VISIT_DATE VISIT_DATE 
									 FROM VISIT_REPORTS visrep,
									 EMP_DETAILS emp,CLIENT_DETAILS clt,CLIENT_APPOINTMENTS	clapp								 
									 WHERE  visrep.APNT_ID = clapp.ID AND visrep.EMP_ID = emp.ID AND visrep.CLIENT_ID=clt.ID ORDER BY visrep.ID DESC");
		                            $result->execute();									
		                            Database::disconnect();
								...
								if ( !empty($_POST)) {	
									...
									$pdo = Database::connect();
									$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
									$sql="select visrep.ID ID, emp.EMP_NAME EMP_NAME, clt.CLIENT_NAME CLIENT_NAME, visrep.VISIT_DATE VISIT_DATE 
									 FROM VISIT_REPORTS visrep,
									 EMP_DETAILS emp,CLIENT_DETAILS clt,CLIENT_APPOINTMENTS	clapp								 
									 WHERE  visrep.APNT_ID = clapp.ID AND visrep.EMP_ID = emp.ID AND visrep.CLIENT_ID=clt.ID AND emp.EMP_NAME LIKE :empName AND clt.CLIENT_NAME LIKE :ClientName AND visrep.VISIT_DATE LIKE :VisitDate ;";
									$result=$pdo->prepare($sql);
									$result->bindValue(':empName',$EMP_NAME.'%');
									$result->bindValue(':ClientName',$CLIENT_NAME.'%');
									$result->bindValue(':VisitDate',$VISIT_DATE.'%');
			 				      ...
			 				      ?>
                                    ...
                                    <td class="actions">
											...
											<a href="deleteEnterVisitReports.php?id=<?php echo $row['ID']; ?>" class="btn btn-small" onclick="return confirm('Are you sure?')" ><i class="icon-remove"></i></a>
										</td>
				...
				<div class="navbar navbar-fixed-bottom">
					<div class="navbar-inner">
						<div class="container">                         
							   ...
							   <a href="addEnterVisitReports.php" class="newenable btn btn-default" onClick="newPage()" id="newenable">
